...
### NOTE
*This project is no longer maintained. You are free to continue using it, but no new features/fixes/improvements will be published. Check out [lugo](https://marketplace.visualstudio.com/items?itemName=coalaura.lugo-vscode) aswell if you are considering alternatives.*
